...
import static com.imooc.security.core.validate.code.ValidateCodeController.SESSION_KEY;
...
public class ValidateCodeFilter extends OncePerRequestFilter {
    ...
    private void validate(HttpServletRequest request) throws ServletRequestBindingException {
        ImageCode codeInSession = (ImageCode) request.getSession().getAttribute(SESSION_KEY_PREFIX + "IMAGE");
